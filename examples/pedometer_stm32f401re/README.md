# LSM6DSV16X Embedded Step Counter on STM32F401RE Nucleo-64

This example demonstrates how to use the **LSM6DSV16X** accelerometer sensor's embedded step counter feature on an **STM32F401RE** microcontroller board. The program configures the sensor to detect steps and outputs the step count over UART.
...
*This README explains the embedded Rust program for embedded step counting on the LSM6DSV16X sensor using STM32F401RE.*
